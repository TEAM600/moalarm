...
public interface HistoryRepository extends JpaRepository<History, Long> {
    ...
    @Query("SELECT new com.team600.moalarm.history.dto.response.HistoryChartDatasetDto(h.type, DATE(h.createdAt), COUNT(h.memberId))\n"
            + "FROM History h\n"
    ...
    List<HistoryChartDatasetDto> getHistoryChartDateset(long memberId, LocalDate start,
            LocalDate end);
}
